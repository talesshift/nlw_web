...
export function FeedbackSucessStep({onSetFeedBackType,onSetFeedBackSent}:FeedbackContentStepProps) {
    function restartFeedback(){
        onSetFeedBackType(null)
        onSetFeedBackSent(false)
    }
    return (
        <>
            <header>
            ...
            <div className="flex flex-col items-center py-10 gap-2 w-[384px]">
                ...
                <button onClick={restartFeedback} type="button" className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-default">
                    Enviar outro...
                </button>
            </div>
        </>
